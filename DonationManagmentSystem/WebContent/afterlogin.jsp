		...
		<nav class="navbar navbar-default navbar-fixed-top"  >
			...
			<div class="collapse navbar-collapse" id="myNavbar">
			  ...
			  <li>
				...
				<li><a onclick="location.href='<%=request.getContextPath() %>/Controller?action=logout'" ><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
			  </ul>
			</div>
		...
		<div id="myCarousel"  class="carousel"     data-ride="carousel">
			  ...
			  <div class="carousel-inner" role="listbox" >
				<div class="item active">
				  <img src="img/c.jpg" style="height:480px;width:100%" alt="Chania">
				<div class="carousel-caption">
         <button type="button" class="btn btn-primary btn-lg" style="position:absolute;z-index:100;left:93%;bottom:20px" onclick="location.href='donate-1.html'">Donate</button>
        </div>
				</div>

				<div class="item">
				  <img src="img/slide-1.jpg" alt="Chania" style="height:480px;width:100%">
				 <div class="carousel-caption">
         <button type="button" class="btn btn-primary btn-lg" style="position:absolute;z-index:100;left:93%;bottom:20px" onclick="location.href='donate-1.html'">Donate</button>
        </div>
